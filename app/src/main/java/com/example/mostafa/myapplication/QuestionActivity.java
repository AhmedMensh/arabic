...
import com.example.mostafa.myapplication.model.Question;
...
public class QuestionActivity extends AppCompatActivity {
    ...
    private ImageView nextQuestionImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextQuestionImageView = findViewById(R.id.next_question_iv);
