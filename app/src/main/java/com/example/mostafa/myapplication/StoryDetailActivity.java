...
import com.example.mostafa.myapplication.adapters.StoryDetailRecycleAdapter;
...
//    private void cancelPauseAfter()
//    {
//        if (this.pauseAfterRunnable != null)
//        {
//            this.playHandler.removeCallbacks(this.pauseAfterRunnable);
//            this.pauseAfterRunnable = null;
//        }
//    }
//
//    private void pauseAfter(long paramLong)
//    {
//        this.pauseAfterRunnable = new Runnable()
//        {
//            public void run()
//            {
...
//            }
//        };
//        this.playHandler.postDelayed(this.pauseAfterRunnable, paramLong);
//    }
    @Override
